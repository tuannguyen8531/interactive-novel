...
envelope. Use typed `KnowledgeClaimProposal` records for initial facts and
never encode an authoritative fact only as prose. Keep the opening scene
`guard_approved` false. Use two to four NPC profiles.
